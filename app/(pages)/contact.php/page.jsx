  ...
  return (
    <main className="font-sans">
      ...
      <section className="relative -mt-38 w-full h-[420px] md:h-[520px] overflow-hidden -z-40">
        ...
        {/* Overlay */}
        {!loading && <div className="absolute inset-0 bg-linear-to-b from-black/30 to-black/60"></div>}

        {/* Text */}
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white text-center px-4">
          {loading ? (
            <>
              <div className="w-64 h-10 bg-gray-300 rounded-md animate-pulse mb-4"></div>
      ...
      <section className="container mx-auto px-6 -mt-20">
        <div className="bg-white/70 backdrop-blur-xl shadow-xl border border-white/50 rounded-3xl px-8 py-12 md:px-16">
          ...
          {loading ? (
            <>
              {/* Title Skeleton */}
              <div className="w-48 h-8 bg-gray-200 mx-auto rounded-md animate-pulse mb-10"></div>
              ...
              <div className="grid md:grid-cols-3 gap-10 text-center">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="flex flex-col items-center">
                    ...
                    <div className="w-32 h-4 bg-gray-200 rounded mt-4 animate-pulse"></div>
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* LEFT FORM */}
          {loading ? (
            <div className="rounded-3xl p-10 bg-gray-100 animate-pulse h-[500px]"></div>
          ) : (
          ...
          {/* RIGHT IMAGE */}
          {loading ? (
            <div className="rounded-3xl bg-gray-200 animate-pulse w-full h-[500px]"></div>
          ) : (
        ...
        <div className="mt-24">
          ...
          {loading ? (
            <>
              <div className="w-40 h-8 bg-gray-200 mx-auto rounded animate-pulse mb-4"></div>
              <div className="w-72 h-4 bg-gray-200 mx-auto rounded animate-pulse mb-6"></div>
