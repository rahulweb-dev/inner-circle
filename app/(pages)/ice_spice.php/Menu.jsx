...
export default function MenuZomato() {
  ...
  const openModal = (product) => {
    ...
    setFormData({ ...formData, product, qty: 1 });
    setShowModal(true);
  };
  ...
  return (
    <div className="w-full min-h-screen bg-white text-black pb-24 px-6">
      ...
      <div className="container mx-auto text-center pt-10 mb-6">
        {loading ? (
          <>
            <Skeleton width={320} height={50} className="mx-auto" />
            <Skeleton width={280} height={20} className="mx-auto mt-3" />
          </>
        ) : (
          <>
            <h1 className="text-5xl md:text-6xl font-black text-[#e8c27d] uppercase">
      ...
      <div className="max-w-xl mx-auto mb-8">
        {loading ? (
          ...
          <div className="bg-[#222] rounded-full px-6 py-3 flex items-center gap-3 shadow-lg">
            <input
              type="text"
      ...
      <div className="flex flex-wrap gap-3 justify-center mb-10">
        {loading ? (
          [...Array(6)].map((_, i) => (
            <Skeleton key={i} width={100} height={35} borderRadius={20} />
          ))
        ) : (
          categories.map(cat => (
            <button
          ...
          ? [...Array(6)].map((_, i) => (
            ...
            >
              ...
              <div className="mt-2">
                ...
                <Skeleton width={100} height={18} className="mt-3" />
              </div>
            </div>
          ))
            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[11px] text-red-500 font-semibold">⭐ Bestseller</span>
                  <span className="text-[11px] text-green-600 font-semibold">★ 4.2 (200+)</span>
                </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50 px-4">
          <OrderForm selectedProduct={selectedProduct} onClose={closeModal} />
        </div>
      )}
    </div>
  );
