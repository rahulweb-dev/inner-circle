...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="w-full flex justify-between items-center px-12 py-5 text-white bg-black/20 backdrop-blur-md border-b border-white/10 relative z-20">
        ...
        <ul className="hidden md:flex gap-10">
          ...
          <li className="relative cursor-pointer"
            ...
            Pages ▾
            {dropdown && (
              <div className="absolute top-6 left-0 bg-white text-black rounded shadow-lg py-3 w-40">
                <Link href='/gallery' ><p className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Gallery</p></Link>
          ...
          <Link href='/rooms.php'> <li className="hover:text-orange-300 duration-200 cursor-pointer">Rooms</li></Link>
      ...
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-64 bg-black/90 text-white z-30 transform ${open ? "translate-x-0" : "translate-x-full"} transition-transform duration-300`}
      >
